...
//        EmployeeList Add = new EmployeeList("10001", "Juztin Kristoffer P. Estacio", "December 7, 2005", "Male").
//                       new EmployeeList("10002", "LeBron James", "December 30, 1984", "Male");
...
//        if(EmployeeInformation)
    ...
    private void CalculateSalaryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculateSalaryActionPerformed
        ...
        //Insert here a showmessagedialog using these below (Task for Allysa)
         JOptionPane.showMessageDialog(this, "Summary\n"//Callout methods on PayrollCalculation.java such as calculate.showBenefits (change the method after calculate.
                                        + "Benefits: sampleInt\n"
